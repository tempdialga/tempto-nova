...
public class BaseColorBatch extends AltBatch{

    public static final String FINAL_FRAG_PATH = "shaders/colorBaseFrag.glsl";
    ...
    public BaseColorBatch(int size, ShaderProgram defaultShader) {
    ...
    public BaseColorBatch(int size) {
        this(size, null);
    }
