...
public class AtlasOrthogonalTiledMapRenderer extends OrthogonalTiledMapRenderer {
    ...
    public AtlasOrthogonalTiledMapRenderer(TiledMap map, Batch batch) {
        super(map, batch);
    }
        ...
        for (int row = row2; row >= row1; row--) {
            ...
            for (int col = col1; col < col2; col++) {
                ...
                if (tile != null) {
                    ...
                    float u1 = region.getU() + tileSetRegion.offsetX*unitScale;
                    float v1 = region.getV2() + tileSetRegion.offsetY*unitScale;
                    float u2 = region.getU2() + tileSetRegion.offsetX*unitScale;
                    float v2 = region.getV() + tileSetRegion.offsetY*unitScale;
                    ...
                    batch.draw(tileSetRegion.getTexture(), vertices, 0, NUM_VERTICES);
                }
                x += layerTileWidth;
            }
            y -= layerTileHeight;
