...
public class AltDepthBatch implements Batch {
    ...
    public AltDepthBatch (int size, ShaderProgram defaultShader) {
        ...
        mesh = new Mesh(vertexDataType, false, size * 4, size * 6,
                ...
                new VertexAttribute(VertexAttributes.Usage.TextureCoordinates, 2, DEPCOORD_ATTRIBUTE+"0"));

        projectionMatrix.setToOrtho2D(0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());

        vertices = new float[size * DEPTH_SPRITE_SIZE];
...
//        return shader;
    ...
    public void flush () {
        ...
        renderCalls++;
        totalRenderCalls++;
        int spritesInBatch = idx / DEPTH_SPRITE_SIZE;
